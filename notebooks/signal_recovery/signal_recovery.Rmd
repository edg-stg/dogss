...
```{r prefigure3, dev="pdf", dev.args=list(onefile=FALSE)}
# this r-chunk is needed to avoid blank plots, bug: https://support.rstudio.com/hc/en-us/community/posts/239529128-Notebooks-grid-newpage
plot_sml(1)
```
...
```{r figure7, fig.height=9.5, fig.width=9, eval=FALSE}
